...
// 객체지향 디자인을 이야기 할때 "Factory" 라는 용어는 아주 널리 사용됩니다.
// => Factory : 객체를 생성할때 사용하는 클래스

// 그런데, GoF's 디자인 패턴 23개 분류에 "factory" 라는 용어 없습니다.
// => abstract factory 가 있습니다.

// abstract factory : 공장도 인터페이스를 먼저 만들어서 교체 할수 있게 하자는 의미
